...
/**
 * like-service와 통신하기 위한 REST 클라이언트입니다.
 * 특정 게시글의 좋아요 수를 조회하는 기능을 제공합니다.
 */
@Slf4j
@Component
...
public class LikeClient {
    ...
    private String likeServiceUrl; // application.yml에서 주입받는 like-service의 URL
    ...
    /**
     * like-service에서 특정 게시글의 총 좋아요 수를 조회합니다.
     * @param articleId 조회할 게시글의 ID
     * @return 총 좋아요 수. 실패 시 0을 반환합니다.
     */
