...
public class KafkaConfig {
    ...
    public ConcurrentKafkaListenerContainerFactory<String, String> kafkaListenerContainerFactory(
        ...
        // 이렇게 하면 메시지 처리가 완료된 후 개발자가 코드 내에서 명시적으로 Acknowledgment.acknowledge()를 호출해야 합니다.
        // 이를 통해 메시지 처리 시점을 정확하게 제어할 수 있으며, 처리 도중 예외가 발생했을 때
        // 메시지를 커밋하지 않고 재처리(redelivery)하도록 보장할 수 있습니다. (at-least-once-delivery)
