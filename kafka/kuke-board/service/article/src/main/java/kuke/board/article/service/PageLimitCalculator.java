...
public final class PageLimitCalculator {
     ...
     *    - 예: page=15, movablePageCount=10 -> (14 / 10) = 1. 즉, 11-20 그룹(1번 그룹)에 속함.
     * 2. `(...) + 1`: 1-indexed 그룹 번호로 변환합니다.
     *    - 예: 1 + 1 = 2. 2번째 페이지 그룹.
     * 3. `(...) * pageSize * movablePageCount`: 현재 페이지 그룹의 마지막 페이지까지 필요한 총 게시글 수를 계산합니다.
     *    - 예: 2 * 10 * 10 = 200. 20페이지까지 꽉 차려면 200개의 게시글이 필요함.
     * 4. `(...) + 1`: 다음 페이지(그룹)에 게시글이 하나라도 더 있는지 확인하기 위해 1을 더합니다.
     *    - 예: 201. 201개의 게시글이 있다면 21페이지가 존재함을 의미.
     *
